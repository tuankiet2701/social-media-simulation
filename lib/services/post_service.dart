...
class PostService extends Service {
  ...
  //upload profile picture to the users collection
  ...
  //upload post to the post collection
  ...
  //add the like to notification collection
  addLikeToNotification(String type, String username, String userId,
